...
ARG NEXT_PUBLIC_QUBEE_EDITOR_ENABLED
ARG NEXT_PUBLIC_QUBEE_EDITOR_RENDERER_ENABLED
ARG NEXT_PUBLIC_QUBEE_PLAYBACK_RENDERER_ENABLED
...
ENV NEXT_PUBLIC_QUBEE_EDITOR_ENABLED=$NEXT_PUBLIC_QUBEE_EDITOR_ENABLED
ENV NEXT_PUBLIC_QUBEE_EDITOR_RENDERER_ENABLED=$NEXT_PUBLIC_QUBEE_EDITOR_RENDERER_ENABLED
ENV NEXT_PUBLIC_QUBEE_PLAYBACK_RENDERER_ENABLED=$NEXT_PUBLIC_QUBEE_PLAYBACK_RENDERER_ENABLED
