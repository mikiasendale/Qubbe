...
import type { AgentInfo } from '@qubee/generation';
import { DEFAULT_LANGUAGE_DIRECTIVE } from '@qubee/generation';
...
// (@qubee/generation outline parser): ignore whitespace-only titles and cap
...
function sanitizeNonTaskEngineOutline(outline: SceneOutline): SceneOutline {
  ...
  // procedural-skill is gated behind taskEngineMode to protect ordinary QUBEE generation.
  return {
    ...outline,
    type: 'interactive',
    widgetType: 'diagram',
