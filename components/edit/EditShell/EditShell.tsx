...
function Frame({
  ...
  return (
    <StageGrid
      ...
      topSlot={
        hideCommandBar ? null : (
          // `data-qubee-edit-chrome`: the workbench's hand-edit signal scope
      ...
      centerSlot={
        ...
        <div
          data-qubee-studio-frame="true"
          className="relative h-full min-h-0 w-full overflow-hidden p-3 sm:p-4"
        >
          {/* `data-qubee-edit-canvas`: the workbench's hand-edit signal scope
          ...
          {usesClassroomAspect(sceneType) ? (
            ...
            >
              <div
                data-qubee-edit-canvas="true"
                data-qubee-stage-card="true"
