...
export function handleInteractivePickerMessage(
  ...
  if (!data || data.__qubeeInteractive !== true) return false;
  ...
  useEffect(() => {
    const onMessage = (e: MessageEvent) => {
      ...
      const d = e.data as
        ...
        | undefined;
      if (!d || d.__qubeeInteractive !== true) return;
    ...
    iframeRef.current?.contentWindow?.postMessage({ __qubeeErrorReplayRequest: true }, '*');
