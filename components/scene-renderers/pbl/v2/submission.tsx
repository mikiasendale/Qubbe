 ...
 *   persisted to IndexedDB by the Qubee stage layer. The Modal's
...
function SubmissionModal({
  ...
  const handleFile = async (file: File) => {
    ...
    abortRef.current = ac;
    // Image / screenshot: store via Qubee's existing object storage
    ...
    // PDF: parse to text via Qubee's existing /api/parse-pdf (reused, not
