...
import { ElementTypes, type PPTElement } from '@qubee/dsl';
...
import { editableElementDomId, qubeeElementIdAttributes } from '../../element-dom';
  ...
  if (!CurrentElementComponent) {
    return (
      <div
        ...
        {...qubeeElementIdAttributes(elementInfo.id)}
