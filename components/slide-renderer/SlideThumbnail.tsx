...
import type { Slide, PPTImageElement, PPTVideoElement } from '@qubee/dsl';
...
/**
 * Read-only thumbnail rendering for a video element. Replaces `@qubee/renderer`'s
...
/**
 * Read-only slide thumbnail rendered via the extracted `@qubee/renderer`
 ...
 * is intentionally untouched (`@qubee/renderer` v1 is read-only; editing is v2).
 */
