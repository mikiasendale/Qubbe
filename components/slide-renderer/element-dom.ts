...
export const QUBEE_ELEMENT_ID_ATTRIBUTE = 'data-qubee-element-id';
...
export function qubeeElementIdAttributes(elementId: string): Record<string, string> {
  return { [QUBEE_ELEMENT_ID_ATTRIBUTE]: elementId };
}
