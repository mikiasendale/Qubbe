...
import { isQubeeEditorEnabled, isProWorkbenchEnabled } from '@/lib/config/feature-flags';
 ...
 * published `@qubee/dsl` and is persisted with the stage, whereas "this is
...
export function Stage({
  ...
  const editorEnabled = isQubeeEditorEnabled();
