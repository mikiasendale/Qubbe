...
export function isAgentRuntimeEnabled(): boolean {
  return readBoolean(process.env.QUBEE_AGENT_RUNTIME_ENABLED);
}
...
/**
 * QUBEE Editor (Pro mode) gate. Default OFF — gates only the Pro toggle
 ...
 */
export function isQubeeEditorEnabled(): boolean {
  return isProWorkbenchEnabled() || readBoolean(process.env.NEXT_PUBLIC_QUBEE_EDITOR_ENABLED);
}
...
export function isPlaybackRendererEnabled(): boolean {
  return readBoolean(process.env.NEXT_PUBLIC_QUBEE_PLAYBACK_RENDERER_ENABLED);
}
...
export function isEditorRendererEnabled(): boolean {
  return readBoolean(process.env.NEXT_PUBLIC_QUBEE_EDITOR_RENDERER_ENABLED);
}
...
export function isPiNativeChildRuntimeEnabled(): boolean {
  return readBoolean(process.env.QUBEE_ENABLE_PI_NATIVE_CHILD_RUNTIME);
}
...
export function isPiNativeChildSpotlightEnabled(): boolean {
  return readBoolean(process.env.QUBEE_ENABLE_PI_NATIVE_CHILD_SPOTLIGHT);
}
...
export function isVocationalTaskEngineEnabled(): boolean {
  return readBoolean(process.env.QUBEE_ENABLE_VOCATIONAL);
}
