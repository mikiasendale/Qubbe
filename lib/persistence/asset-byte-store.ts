 ...
 */
import { PgAssetByteStore } from '@qubee/storage/asset/pg-bytes';
import type { AssetByteStore, Queryable } from '@qubee/storage/asset/pg';
...
export async function createAssetByteStore(
  ...
  const storage = await import('@qubee/storage/asset/s3-bytes');
