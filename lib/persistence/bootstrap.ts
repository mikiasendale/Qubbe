import { BrowserKVStore, HttpDocumentStore, type HttpDocumentHeadersHook } from '@qubee/storage';
import { HttpRuntimeStore, type HttpRuntimeHeadersHook } from '@qubee/storage/runtime/http';
