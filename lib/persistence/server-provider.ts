import { PgAssetStore, ensureAssetSchema } from '@qubee/storage/asset/pg';
import { PgDocumentStore, ensureDocumentSchema } from '@qubee/storage/document/pg';
import { PgRuntimeStore, ensureSchema } from '@qubee/storage/runtime/pg';
import {
  nodePostgresTransaction,
  type ConnectableQueryable,
} from '@qubee/storage/server/reference';
import { Pool } from 'pg';
...
const PROVIDER_STATE_KEY = Symbol.for('qubee.persistence.provider');
