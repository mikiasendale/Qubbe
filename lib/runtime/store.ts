...
/**
 * Lazy app-wide RuntimeStore singleton (#869). One `qubee-runtime` IndexedDB
 ...
 */
import { BrowserRuntimeStore, type RuntimeStore } from '@qubee/storage';
...
const RUNTIME_DB_NAME = 'qubee-runtime';
 ...
 * (`qubee-runtime`), so a broken or hung runtime DB must not brick stage
