...
export const AGENT_EVENT_NOTIFY_CHANNEL = 'qubee_agent_event_wakeup';
/**
 ...
 */
export const AGENT_EVENT_PROBE_CHANNEL = 'qubee_agent_event_selfcheck';
export const AGENT_EVENT_NOTIFY_APPLICATION_NAME = 'qubee-agent-notify-bus';
...
const GLOBAL_KEY = '__qubeeAgentEventNotifyBus';
...
const AGENT_EVENT_PROBE_PAYLOAD = 'qubee-agent-notify-selfcheck';
