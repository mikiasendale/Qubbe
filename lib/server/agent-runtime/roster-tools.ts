...
import type { DocumentStore, QubeeDocument } from '@qubee/storage';
import type { GeneratedAgentConfig, Stage } from '@qubee/dsl';
...
export type CourseDocument = QubeeDocument<Scene, Stage>;
