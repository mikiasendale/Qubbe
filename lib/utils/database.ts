...
import type { RuntimeStore } from '@qubee/storage';
import {
...
import { BrowserKVStore } from '@qubee/storage';
 ...
 * course document itself (which is owned by the `@qubee/storage`
...
const DATABASE_NAME = 'QUBEE-Database';
const _DATABASE_VERSION = 17;

/**
 * QUBEE Database Instance
 */
class QUBEEDatabase extends Dexie {
  // Table definitions
...
export const db = new QUBEEDatabase();
