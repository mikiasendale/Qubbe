...
function staticCaptureInjection(): string {
  ...
  return `
<meta data-qubee-static-csp http-equiv="Content-Security-Policy" content="default-src 'none'; script-src 'unsafe-inline' 'unsafe-eval' data: blob:; style-src 'unsafe-inline' data:; img-src data: blob:; font-src data:; media-src data: blob:; worker-src 'none'; connect-src 'none'; frame-src 'none'; object-src 'none'; base-uri 'none'">
<script data-qubee-static-capture>
(function () {
  var FLAG = ${flag};
  var frozen = false;
  ...
  function freeze() {
    ...
    style.setAttribute('data-qubee-static-frozen', '');
    ...
    document.documentElement.setAttribute('data-qubee-static-state', 'frozen');
  }

  window.__qubeeFreezeInteractive = freeze;
