import { normalizeElement, type CodeLine, type PPTElement, type Whiteboard } from '@qubee/dsl';
import sceneSchemaJson from '@qubee/dsl/schema/scene.schema.json';
import type { RuntimePayloadValidator } from '@qubee/storage';
