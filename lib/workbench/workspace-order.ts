...
/** localStorage keys. Same `qubee:workspace:` namespace as the rail width. */
export const COURSE_ORDER_STORAGE_KEY = 'qubee:workspace:course-order';
export const SESSION_ORDER_STORAGE_KEY = 'qubee:workspace:session-order';
