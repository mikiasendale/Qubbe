...
export const NAV_COLLAPSED_STORAGE_KEY = 'qubee:workspace:nav-collapsed';
export const CHAT_COLLAPSED_STORAGE_KEY = 'qubee:workspace:chat-collapsed';
export const CLASSROOM_COLLAPSED_STORAGE_KEY = 'qubee:workspace:classroom-collapsed';
export const CHAT_WIDTH_STORAGE_KEY = 'qubee:workspace:chat-width';
