/**
 * The QUBEE slide object model — the canonical, dependency-free contract.
 *
 * This file is the single source of truth that supersedes the three copies that
 * had drifted apart before @qubee/dsl existed:
 *   - app:      lib/types/slides.ts
 *   - renderer: packages/@qubee/renderer/src/types/slides.ts
 *   - importer: packages/@qubee/importer/src/qubee/types/slides.ts
 *
