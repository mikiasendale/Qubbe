 ...
 * document to another runtime. `@qubee/renderer` already consumes resolved
 ...
 * future `@qubee/exporter` package can build on the same contract.
 *
 ...
 * CDN on a server — live in `@qubee/storage`, keeping this package
 ...
 * pure package to the DOM lib. Backends in `@qubee/storage` accept a real
