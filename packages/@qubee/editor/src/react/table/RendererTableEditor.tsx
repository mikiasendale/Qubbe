...
import type { PPTTableElement, TableCell, TableCellBorder } from '@qubee/dsl';
import { getTableSubThemeColor } from '@qubee/renderer';
import { getTextStyle } from '@qubee/renderer/elements';
