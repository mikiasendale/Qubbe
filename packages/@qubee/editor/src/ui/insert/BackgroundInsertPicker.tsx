...
import type { SlideBackground } from '@qubee/dsl';
...
export function BackgroundInsertPicker({
  ...
  return (
    <div className="qubee-editing-ui-background-picker">
      <div className="qubee-editing-ui-background-tabs" role="tablist">
        <button
          type="button"
          role="tab"
          aria-selected={tab === 'solid'}
          className="qubee-editing-ui-background-tab"
      ...
      {tab === 'solid' ? (
        <label className="qubee-editing-ui-background-color-field">
          <span>{labels.color}</span>
          <span className="qubee-editing-ui-background-color-inputs">
            <input
              type="color"
        ...
        <div className="qubee-editing-ui-background-image-picker">
