...
function InsertToolbarButton({
  ...
  return (
    <button
      type="button"
      className="qubee-editing-ui-icon-button qubee-editing-ui-insert-button qubee-editing-ui-tooltip-button"
...
export function InsertToolbar({
  ...
  return (
    <div
      ref={rootRef}
      className={['qubee-editing-ui-root', 'qubee-editing-ui-insert-toolbar', className]
        .filter(Boolean)
        .join(' ')}
      role="toolbar"
      aria-label={label}
    ...
    >
      <div className="qubee-editing-ui-insert-buttons">
        {items.map((item) => (
          <InsertToolbarButton
            key={item.id}
            item={item}
      ...
      {openItem?.renderPopover ? (
        <div
          className="qubee-editing-ui-insert-popover"
          role="dialog"
