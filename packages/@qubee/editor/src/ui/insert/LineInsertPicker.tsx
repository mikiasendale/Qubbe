...
import type { LinePoint, LineStyleType } from '@qubee/dsl';
...
export function LineInsertPicker({ labels: labelOverrides, onPick }: LineInsertPickerProps) {
  ...
  return (
    <div className="qubee-editing-ui-line-insert-picker" role="group" aria-label={labels.label}>
      {PRESETS.map(({ label, preset }) => (
        <button
          key={label}
          type="button"
          aria-label={labels[label]}
          className="qubee-editing-ui-line-insert-option qubee-editing-ui-tooltip-button"
