...
export function TableInsertPicker({ onPick, getLabel }: TableInsertPickerProps) {
  ...
  return (
    <div className="qubee-editing-ui-table-picker">
      <div className="qubee-editing-ui-table-grid" role="grid">
          ...
          Array.from({ length: MAX_COLUMNS }, (_, columnIndex) => {
            ...
            return (
              <button
                ...
                className="qubee-editing-ui-table-grid-cell"
              />
            );
          }),
        )}
      </div>
      <div data-testid="table-insert-dimensions" className="qubee-editing-ui-table-dimensions">
