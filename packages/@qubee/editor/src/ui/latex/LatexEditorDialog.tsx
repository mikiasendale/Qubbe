...
export function LatexEditorDialog({
  ...
  return (
    <div className="qubee-editing-ui-latex-backdrop" onPointerDown={onClose}>
      <section
        className="qubee-editing-ui-latex-dialog"
        role="dialog"
        aria-modal="true"
        aria-label={labels.dialog}
        onPointerDown={(event) => event.stopPropagation()}
      >
        <div className="qubee-editing-ui-latex-main">
          <div className="qubee-editing-ui-latex-workspace">
            <label className="qubee-editing-ui-latex-source-label" htmlFor="qubee-latex-source">
              {labels.source}
            </label>
            <textarea
              ref={sourceRef}
              id="qubee-latex-source"
              className="qubee-editing-ui-latex-source"
              value={latex}
              onChange={(event) => setLatex(event.target.value)}
              spellCheck={false}
            />
            <div className="qubee-editing-ui-latex-preview-shell">
              <span className="qubee-editing-ui-latex-preview-label">{labels.preview}</span>
              <div className="qubee-editing-ui-latex-preview" data-testid="latex-editor-preview">
              ...
              <p className="qubee-editing-ui-latex-error" role="status" aria-live="polite">
        ...
        <footer className="qubee-editing-ui-latex-footer">
          <button type="button" className="qubee-editing-ui-latex-cancel" onClick={onClose}>
            {labels.cancel}
          </button>
          <button
            type="button"
            className="qubee-editing-ui-latex-confirm"
            disabled={!canConfirm}
            onClick={confirm}
          >
            {labels.confirm}
