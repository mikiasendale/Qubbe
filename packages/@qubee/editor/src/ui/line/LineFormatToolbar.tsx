...
import type { LinePoint, LineStyleType, PPTLineElement } from '@qubee/dsl';
...
export function LineFormatToolbar({
  ...
  return (
    <div
      className={['qubee-editing-ui-root', 'qubee-editing-ui-line-toolbar', className]
        .filter(Boolean)
        .join(' ')}
      role="toolbar"
    ...
    >
      <select
        className="qubee-editing-ui-select qubee-editing-ui-line-select"
      ...
      <button
        ref={colorButtonRef}
        type="button"
        className="qubee-editing-ui-icon-button qubee-editing-ui-color-button"
      ...
      >
        <span
          className="qubee-editing-ui-color-button-preview"
          aria-hidden="true"
          style={{ backgroundColor: element.color }}
        />
      </button>
      <select
        className="qubee-editing-ui-select qubee-editing-ui-line-width-select"
      ...
      {(['start', 'end'] as const).map((position, index) => (
        <select
          key={position}
          className="qubee-editing-ui-select qubee-editing-ui-line-marker-select"
      ...
      {onBringToFront || onSendToBack || onDelete ? (
        <>
          <div className="qubee-editing-ui-divider" aria-hidden="true" />
          {onBringToFront ? (
            <button
              type="button"
              className="qubee-editing-ui-icon-button"
          ...
          {onDelete ? (
            <button
              type="button"
              className="qubee-editing-ui-icon-button qubee-editing-ui-delete-button"
      ...
      {isColorPickerOpen && typeof document !== 'undefined'
        ? createPortal(
            <div
              ref={colorPopoverRef}
              className="qubee-editing-ui-root qubee-editing-ui-color-popover qubee-editing-ui-color-popover-overlay"
              role="dialog"
              aria-label={labels.color}
