...
export function FontSizeControl({ value, labels, onCommand }: FontSizeControlProps) {
  ...
  return (
    <div className="qubee-editing-ui-font-size-stepper" role="group" aria-label={labels.fontSize}>
      <button
        type="button"
        className="qubee-editing-ui-step-button"
      ...
      <input
        ...
        inputMode="numeric"
        role="spinbutton"
        className="qubee-editing-ui-font-size-input"
