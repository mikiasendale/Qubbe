...
function Divider() {
  return <div className="qubee-editing-ui-divider" aria-hidden="true" />;
}
...
export function TextFormatToolbar({
  ...
  const classes = ['qubee-editing-ui-root', 'qubee-editing-ui-text-toolbar', className]
    .filter(Boolean)
    .join(' ');
  ...
  return (
    <div className={classes} role="toolbar" aria-label={labels.toolbar} data-placement={placement}>
      <div className="qubee-editing-ui-group qubee-editing-ui-font-group">
        <select
          className="qubee-editing-ui-select"
      ...
      <Divider />
      <div className="qubee-editing-ui-group">
        <button
          type="button"
        ...
        <div className="qubee-editing-ui-color-control">
          <button
            ref={colorButtonRef}
            type="button"
