...
export function VideoInsertPicker({ labels, onInsert }: VideoInsertPickerProps) {
  ...
  return (
    <div className="qubee-editing-ui-video-insert-picker">
      <button
        type="button"
        className="qubee-editing-ui-video-dropzone"
      ...
      />
      <div className="qubee-editing-ui-video-or">{labels.videoOr}</div>
      <div className="qubee-editing-ui-video-url-row">
        <input
          type="url"
          value={url}
