...
import type { PPTVideoElement } from '@qubee/dsl';
...
export function VideoToolbarOverlay({
  ...
  return createPortal(
    <div
      ref={rootRef}
      className="qubee-editing-ui-root qubee-editing-ui-video-toolbar-root"
    ...
    >
      <div
        ref={toolbarRef}
        className="qubee-editing-ui-video-toolbar"
        role="toolbar"
      ...
      >
        {renderPosterPicker ? (
          <button
            type="button"
            className="qubee-editing-ui-icon-button qubee-editing-ui-tooltip-button"
        ...
        {onBringToFront || onSendToBack || onDelete ? (
          <span className="qubee-editing-ui-divider" aria-hidden="true" />
        ) : null}
        {onBringToFront ? (
          <button
            type="button"
        ...
        {onDelete ? (
          <>
            ...
            <button
              type="button"
              className="qubee-editing-ui-icon-button qubee-editing-ui-delete-button qubee-editing-ui-tooltip-button"
      ...
      {showPosterPicker ? (
        <div
          className="qubee-editing-ui-video-poster-popover"
          role="dialog"
          aria-label={labels.poster}
        >
          {renderPosterPicker({
