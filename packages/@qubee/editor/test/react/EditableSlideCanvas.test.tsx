...
import { useViewportSize } from '@qubee/renderer';
import { getLineElementPath } from '@qubee/renderer';
...
vi.mock('@qubee/renderer', async (importOriginal) => ({
  ...(await importOriginal<typeof import('@qubee/renderer')>()),
