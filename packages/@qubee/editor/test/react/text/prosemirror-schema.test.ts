...
describe('renderer ProseMirror schema', () => {
  it('round-trips legacy rich-text nodes and marks', () => {
    const html =
      '<blockquote><p style="text-align: center"><a href="https://qubee.chat"><strong><u><span style="font-size: 28px; color: #ff0000">QUBEE</span></u></strong></a></p></blockquote><ol><li><p>One</p></li></ol>';
    ...
    expect(output).toContain('href="https://qubee.chat"');
