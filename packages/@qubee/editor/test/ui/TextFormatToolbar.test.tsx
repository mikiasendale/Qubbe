...
describe('TextFormatToolbar', () => {
  ...
  it('uses the legacy control order and visual structure', () => {
    ...
    expect(toolbar.classList).toContain('qubee-editing-ui-text-toolbar');
    expect(container.querySelector('.qubee-editing-ui-font-size-stepper')).not.toBeNull();
    expect(container.querySelectorAll('.qubee-editing-ui-divider')).toHaveLength(4);
    expect(
