...
import { isWidgetType, normalizeElement } from '@qubee/dsl';
...
export interface SceneContentOptions {
  ...
  /**
   * Natural-language edit instruction for whole-slide regeneration (QUBEE Editor
 ...
 * owned by the DSL contract — `normalizeElement` from `@qubee/dsl` — rather
...
async function generateSlideContent(
  ...
  // EDIT MODE (QUBEE Editor agent `regenerate_scene`): when an edit instruction
