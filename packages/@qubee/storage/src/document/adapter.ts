 ...
 * portable, embedded {@link QubeeDocument} and the per-entity rows a backend
 ...
 */
import { DSL_VERSION, DSL_VERSION_KEY } from '@qubee/dsl';
import type { Stage } from '@qubee/dsl';
import type { QubeeDocument, SceneLike } from './types.js';
...
export function reassembleDocument<TScene extends SceneLike, TStage extends Stage = Stage>(
  ...
  const doc: QubeeDocument<TScene, TStage> = { stage, scenes, dslVersion };
