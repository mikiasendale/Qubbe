/**
 * @qubee/storage — the QUBEE pluggable persistence layer.
 *
 * Dependency arrow (kept acyclic): `@qubee/storage -> @qubee/dsl` only.
...
export type { AssetRef, AssetMeta, BinaryBlob, StorageProvider } from '@qubee/dsl';
