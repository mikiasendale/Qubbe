...
import type { Scene } from '@qubee/dsl';
import { DocumentVersionError, type DocumentStore, type QubeeDocument } from '../src/index.js';
...
export function makeDocument(stageId = 'stage-1'): QubeeDocument {
  return {
