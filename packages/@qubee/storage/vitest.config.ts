...
// Resolve `@qubee/storage` self-imports and the `@qubee/dsl` dependency to
...
export default defineConfig({
  resolve: {
    alias: {
      '@qubee/storage': fileURLToPath(new URL('./src/index.ts', import.meta.url)),
      '@qubee/dsl': fileURLToPath(new URL('../dsl/src/index.ts', import.meta.url)),
    },
  },
  test: {
