 ...
 * `data-qubee-element-id`, with the painted box on `.element-content`. This is
...
function mountLegacyHost(elementId: string, top: number) {
  ...
  host.setAttribute(QUBEE_ELEMENT_ID_ATTRIBUTE, elementId);
...
async function render(includePins = false) {
  ...
  frame.setAttribute('data-qubee-studio-frame', 'true');
