...
import { BrowserRuntimeStore, type QubeeDocument, type RuntimeStore } from '@qubee/storage';
...
function document(whiteboard?: Whiteboard[]): QubeeDocument<AppScene, AppStage> {
  return {
    stage: {
      id: 'stage-1',
      name: 'Stage',
