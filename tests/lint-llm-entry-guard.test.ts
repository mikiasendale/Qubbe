 ...
 * `@qubee` package directories excluded from the dynamic-import ban, and both
...
const GUARDED_PATHS = [
  ...
  'app/api/probe/route',
  'components/probe',
  'packages/@qubee/renderer/src/probe',
  'packages/@qubee/storage/src/probe',
  'packages/@qubee/generation/src/probe',
...
describe('LLM entry-point lint guard — coverage matrix', () => {
  ...
  it('still enforces the pre-existing module boundaries it shares a rule key with', async () => {
    ...
    for (const filePath of [
      'packages/@qubee/renderer/src/probe.ts',
      'packages/@qubee/storage/src/probe.ts',
      'packages/@qubee/generation/src/probe.ts',
